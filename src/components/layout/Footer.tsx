    ...
    <footer className="bg-stone-900 text-stone-400 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-white font-semibold mb-3">Çanakçı Seramik</h3>
            <p className="text-sm leading-relaxed">
              El yapımı seramiklerin sıcaklığını evinize taşıyoruz. Her parça özenle
              hazırlanır.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <a
              href="https://www.instagram.com/canakkaledeseramik/"
              target="_blank"
        ...
        <div className="border-t border-stone-700 mt-8 pt-8 text-center text-xs">
          &copy; {new Date().getFullYear()} Çanakçı Seramik. Tüm hakları saklıdır.
        </div>
      </div>
    </footer>
  )
